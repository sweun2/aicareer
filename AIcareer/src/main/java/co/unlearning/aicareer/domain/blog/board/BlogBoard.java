package co.unlearning.aicareer.domain.blog.board;
...
public class BlogBoard {
    ...
    @OneToMany(mappedBy = "jobBoard",fetch = FetchType.EAGER, cascade = {jakarta.persistence.CascadeType.ALL}, orphanRemoval = true)
